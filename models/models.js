...
db.once('open', function callback () {
  ...
  var classSchema = mongoose.Schema({
    ...
    culture: [ObjectId],				//ids of cultures that it belongs to (European, French, Parisian)
  	...
  	//sessions: { type: [{timeAndDates: [{start: Date, end: Date}], participants: [ObjectId], numWeeks: Number }], required: true },	//dates the class is offered, Number of People Signed up
  	tags: [String],						//tags
  	meta: {	type: {							//meta data
