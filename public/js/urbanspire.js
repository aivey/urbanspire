// Constants
var p4 = {teacher_name:"Margaret", class_name:"Italian Art", description: "Learn the ancient artistic tradition of Italian Art. Beginning with the Neolithic age, Ill take you through the hisory of Italian art through the present day. Come ready to be amazed and to appreciate the beauty Italian artists have created for us.", photo: "/images/hands.png"};
var p5 = {teacher_name:"Asli", class_name:"Korean Dance", description: "Dance in Korea began over 5,000 years ago with shamanistic early rituals. We will explore the deep history of Korean dance, and focus on Folk dance, a style the blends the old and the new", photo: "/images/korean_women.png"};
var p6 = {teacher_name:"Margaret", class_name:"Russian Crafts", description: "Matryoshka dolls represent the matryoshka principle that remindes of of relationship of objects within similar objects, a relationship that appears in nature other art pieces.  We will discuss the significance of the dolls,and use them as a starting point to understand the rich art and culture of Russia.", photo: "/images/dolls.png"};
var p7 = {teacher_name:"Asli", class_name:"South Asian Painting", description: "Experience the history of South Asia while learning the painting craft.  I paint every weekend, at least, and see no greater joy than sharing my talents with others.", photo: "/images/painting.png"};
var p8 = {teacher_name:"Nikhita", class_name:"South African Weaving", description: "Learn the beauty and color of Africa through a weaving class. I know we will enjoy chatting about history and our lives in San Francisco.  Weaving is the perfect activity to share with a new friend", photo: "/images/weavebowl.jpg"};
var p9 = {teacher_name:"Margaret", class_name:"Mediterranean Cooking", description: "Discover the wonders of Mediterranean  cuisine.  My Big Fat Greek Wedding was only the start of all the fun.  Let me know ahead of time if there are any specifics you want to cover, and I'll make sure we're covered.", photo: "/images/greekfood.png"};
var korean_dance = {teacher_name:"Asli", class_name:"Korean Dance", description: "Dance in Korea began over 5,000 years ago with shamanistic early rituals. We will explore the deep history of Korean dance, and focus on Folk dance, a style the blends the old and the new", photo: "/images/korean_women.png"};
var turkish_dance = {teacher_name:"Asli", class_name:"Turkish Belly Dance", description: "Haven't you always wondered the tricks to being a beautiful and skilled belly dancer? I've been dancing and teaching since my youth, and am excited at the opportunity to share my love of the craft with San Francisco.  All levels welcome, come ready to move!", photo: "/images/turkish_dance.png"};
var japanese_dance = {teacher_name:"Asli", class_name:"Japanese Dancing", description: "Japan is a land like no other.  The best way I know to share the beauty of my home country is through the performing arts.  Come for an afternoon and let me share the joy I experience from Japanese dance with you.", photo: "/images/japan.png"};
...
function home_teach(){
	window.location.href = 'main_teach';
}
...
function explore(){
	...
	window.location.href = 'urbanspire_learn?' + combo;
}
...
function teach(){
	...
	var subject = document.getElementById("subject").value;
	var combo = location.concat(subject);
	window.location.href = 'urbanspire_teach?' + combo;
}
...
function search(){
	...
	if (key =="learn"){
		...
		window.location.href = 'urbanspire_teach';
	}
...
document.addEventListener('click', function(event){
	...
	if(target_class == "square"){
		...
		document.getElementById("icon").src = "/images/"+classes[index].teacher_name + ".png";
